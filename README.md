...
4. A command prompt will open. Use the arrow keys to move down and press Enter on `1.8.9`, then `Forge` if you plan on using other mods along with Podcrash. Then type the amount of gigabytes of ram to allocate. `2` is recommended for lower-end machines, and `4` for mid to higher-end machines. 
